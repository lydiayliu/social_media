<?php
  ...
  echo "AccessRight import done!<br/>";
  ...
  echo "Annotation import done!<br/>";
  ...
  echo "CircleMembership import done!<br/>";
  ...
  echo "Collection import done!<br/>";
  ...
  echo "FriendCircle import done!<br/>";
  ...
  echo "Friendship import done!<br/>";
  ...
  echo "Invitation import done!<br/>";
  ...
  echo "Recommendation import done!<br/>";
