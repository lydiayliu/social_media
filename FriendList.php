  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
            ...
            <div class="row">
                <div class="col-sm-3">
                    ...
                    if ($friend_list->num_rows == 0) { ?>
                        <img src="image1.jpeg" class="img-responsive" style="width:100%" alt="Image"> <br> <?php echo "No friends yet. Go get some friends!";
                    } else {
                        while ($row = mysqli_fetch_assoc($friend_list)) {
                            ...
                            ?>
                            <img src="image5.png" style="width:80%" alt="Image">
                            <p><?php
        ...
        <?php } ?>
          <form action="friending_backend.php" method="post" style="text-align: right;">
