<?php
 ...
 try{
     ...
     $bp_sql = "CREATE TABLE `BlogPhoto` ( `bpID` INT AUTO_INCREMENT NOT NULL , `accountID`INT NOT NULL , `isPhoto` BOOLEAN NOT NULL DEFAULT FALSE , `content`BLOB NOT NULL , `timestamp` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , PRIMARY KEY(`bpID`), FOREIGN KEY (`accountID`) REFERENCES Account(`accountID`))";
